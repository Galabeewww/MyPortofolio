  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.name || !formData.email || !formData.message) {
      MySwal.fire({
        ...
        text: 'Mohon isi semua bidang sebelum mengirim pesan.',
    ...
    setTimeout(() => {
      ...
      MySwal.fire({
        ...
        text: 'Terima kasih telah menghubungi saya. Saya akan membalas pesan Anda sesegera mungkin.',
        timer: 3000,
    ...
    <section id="contact" className="py-24 relative border-t border-[var(--border-color)]">
      <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
        <h2 className="text-3xl sm:text-4xl font-bold font-display text-[var(--text-primary)]">
          Hubungi <span className="underline underline-offset-8 decoration-1">Saya</span>
        </h2>
        <p className="text-[var(--text-secondary)] text-sm sm:text-base">
          Punya pertanyaan atau ingin bekerja sama? Kirimkan pesan di bawah ini!
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 text-left">
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="glow-card p-8 rounded-2xl border border-[var(--border-color)] bg-[var(--bg-card)] space-y-8">
        ...
        <div className="lg:col-span-7">
          <form
            ...
            className="glow-card rounded-2xl p-8 space-y-5 bg-[var(--bg-card)] border border-[var(--border-color)]"
          >
            <div>
              <label
                htmlFor="name"
            ...
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-2 py-3.5 rounded-xl bg-[var(--accent-btn)] hover:bg-[var(--accent-btn-hover)] text-[var(--accent-btn-text)] font-semibold text-sm shadow-md transition-all duration-200 cursor-pointer disabled:opacity-50"
            >
              {status === 'sending' ? (
                'Mengirim Pesan...'
              ) : (
